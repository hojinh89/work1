        ...
        <%-- 댓글 영역 --%>
	            <div class="box box-warning">
	              ...
	              <div class="box box-success">
						...
						<%--댓글 목록--%>
						<div class="box-body repliesDiv">댓글목록</div>
						<%--댓글 페이징--%>
						<div class="box-footer">
...
<script id="replyTemplate" type="text/x-handlebars-template">
    ...
    <div class="post replyDiv" data-replyNo={{replyNo}} >
		...
		<div id="replyContext">
        <text style = "color : black;" class = "oldReplyText" id = "replyClickBtn" name="replyClickBtn">
			{{{escape replyText}}}
			</text>
		</div>
        <br>
...
<script id="reReplyWrite" type="text/x-handlebars-template">
<div class="box box-warning ">
 	...
 	$(document).on("click", "div[id='replyContext']", function(){
 		...
 		//입력받는 창 등록
                    var replyEditor = 
                       ...
                       '   </td>'+
                       '   <td align="center">'+
                       '       <button name="reply_reply_save" reply_id="reply11">등록</button>'+
