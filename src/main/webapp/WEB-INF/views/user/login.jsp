    ...
    <div class="login-box-body">
        ...
        <form action="#" method="post">
           <table style="cellpadding: 0; cellspacing: 0; margin: 0 auto; width: 100%">
                  ...
                  <tr>
                     <td><input type="password" size="17" maxlength="20" id="loginPw"
                  ...
                  <tr>
                     <td style="width: 100%; text-align: center; colspan: 2;"><input
                        type="button" value="로그인" class="btn form-control tooltipstered" id="login-btn"
...
<script src="<c:url value='/dist/js/custom/test11.js'/>"></script>
